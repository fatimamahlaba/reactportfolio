...
<section
   ...
   <div className="flex-1">
      <h1 className="text-center md:text-4xl pb-2 text-2xl md:leading-normal leading-10 text-white font-semibold">About <span className="text-cyan-600">Me</span></h1><br />
